        ...
        {history.length === 0 ? (
            ...
            {history.map((item) => (
                ...
                <button
                    ...
                    className={`w-full text-left p-4 hover:bg-gray-50 transition-all flex items-start group ${selectedId === item.id ? 'bg-indigo-50/70 border-l-4 border-indigo-500' : 'border-l-4 border-transparent'}`}
                >
